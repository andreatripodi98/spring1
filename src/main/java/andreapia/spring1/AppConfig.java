...
public class AppConfig {
    ...
    @Bean("Tavolo1")
    Tavolo getTavolo1(@Value("${costo.coperto}") double seatPrice) {
        return new Tavolo(1, 5, true, seatPrice);
    }

    @Bean("Tavolo2")
    Tavolo getTavolo2(@Value("${costo.coperto}") double seatPrice) {
        return new Tavolo(2, 4, true, seatPrice);
    }

    @Bean("Tavolo3")
    Tavolo getTavolo3(@Value("${costo.coperto}") double seatPrice) {
